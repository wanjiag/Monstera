...
re_process = FALSE
file_name =  './csv_files/R-tmp/all-sub-phase-df_n=11_0921.RDS'
...
### 09/28 presentation tmp figures

```{r 09/28 presentation tmp figures}
...
```{r 09/28 presentation tmp figures 2}
library(ez)
...
```{r 09/28 presentation tmp figures 3}
...
```{r 09/28 presentation tmp figures 4}
t.test(d %>% filter(segment == 'same' & phase == 'late-late') %>% .$mean,
